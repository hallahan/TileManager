...
public abstract class TileSet {
     ...
     * including OpenStreetMap, MapQuest, MapBox, and Esri. We also have
     * the tile type be an image by default.
     */
    public TileSet() {
    ...
    /**
     * You can specify the type of tile: IMAGE or GRID. This constructor
     * sets the schema to GoogleTile by default.
     * 
     * @param type 
     */
    ...
    /**
     * Gets the tile with the corresponding coordinates from the cache.
     * If not, a new tile is created.
     * 
     * @param coord
